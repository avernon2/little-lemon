...
const BookingForm: FC<BookingFormProps> = ({ availableTimes, dispatch, ...props }): JSX.Element => {
  ...
  return (
    <Container {...props}>
      ...
      {formik.errors.date && <FormMessageError>{formik.errors.date}</FormMessageError>}
      {formik.errors.time && <FormMessageError>{formik.errors.time}</FormMessageError>}
      {formik.errors.guests && <FormMessageError>{formik.errors.guests}</FormMessageError>}
      {formik.errors.occasion && <FormMessageError>{formik.errors.occasion}</FormMessageError>}
      </Form>
    </Container>
  );
};
